...
const config: ResolvedAstroPaperConfig = {
  site: {
    ...
    googleVerification:
      userConfig.site.googleVerification || import.meta.env.PUBLIC_GOOGLE_SITE_VERIFICATION,
    googleTagId: userConfig.site.googleTagId || import.meta.env.PUBLIC_GOOGLE_TAG_ID,
  },
  posts: {
